...
export const API_ENDPOINTS = {
  ...
  AddEmployeeAttendance: isUsingVercelProxy ? '?path=/api/Attendance/add-employee-attendance' : '/api/Attendance/add-employee-attendance',
  UpdateEmployeeAttendance: isUsingVercelProxy ? '?path=/api/Attendance/update-employee-attendance' : '/api/Attendance/update-employee-attendance',
